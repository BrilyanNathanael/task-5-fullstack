## Task 5 Fullstack
This project is the final project of the Virtual Internship Fullstack Developer (Investree), which is an article management system, there is a website-based CRUD and can also use the API

In this project, the technology used:
- HTML
- CSS
- JQuery
- Laravel9
